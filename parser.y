...
local_var_body  : type local_var_end | TK_IDENTIFICADOR ';'
local_var_end   : ';' | TK_OC_LE var_attr ';'

ternary			: var_attr ternary_body
ternary_body	: %empty | '?' var_attr ':' var_attr
...
expr_vals		: TK_LIT_FLOAT | TK_LIT_INT | TK_IDENTIFICADOR id_seq piped | '(' expr ')' | bool
